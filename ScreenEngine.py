...
class GameSurface(ScreenHandle):
    ...
    def draw_map(self):
        ...
        min_x, min_y = self.calculate(min_x, min_y, size)
    ...
    def calculate(self, calc_x, calc_y, sprite_size):
        screen_size = list(self.get_size())
        screen_size[0] /= sprite_size
        screen_size[1] /= sprite_size
        hero_pos = self.game_engine.hero.position
        calc_x = int(max(0, hero_pos[0] - screen_size[0] + 3))
        calc_y = int(max(0, hero_pos[1] - screen_size[1] + 3))
...
class HelpWindow(ScreenHandle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.data.append(["", "You shan't win"])
